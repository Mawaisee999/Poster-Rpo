    ...
    <div class="jumbotron my-4 col-10">
        ...
        <form class="form-horizontal" method="get" action="{{url('/ssuccess')}}">
            <fieldset>
                ...
                <div class="form-group">
                    <label for="inputEmail" class="col-lg-2 control-label  text-danger">Email</label>
                    <div class="col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <input id="mnumber" type="phone" class="form-control" name="mnumber"   value="{{$user->mobileNum}}" >
                    </div>
                </div>
